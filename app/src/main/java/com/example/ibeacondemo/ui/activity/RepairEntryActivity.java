 ...
 * desc   : 报修录入
 */
public final class RepairEntryActivity extends AppActivity {
    private TextView tv_title_company_name, tv_title_equipment_type;

    private TextView mCompanyName, mEquipmentType;
    ...
    protected int getLayoutId() {
        return R.layout.repair_entry_activity;
    }
    ...
    protected void initView() {
        ...
        setOnClickListener(R.id.tv_company_name, R.id.tv_equipment_type, R.id.btn_inquire);
                        ...
                        public void onSucceed(Object result) {
                            if (result != null) {
                                ...
                                if (Util.getJSONType(replaceJson)) {
                                    ...
                                    new SelectDialog.Builder(RepairEntryActivity.this)
                                            .setTitle("选择公司")
                                            .setSingleSelect()
                                            .setList(dataSet)
                                            .setSelect(0)
