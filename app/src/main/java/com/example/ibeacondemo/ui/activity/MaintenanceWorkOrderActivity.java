 ...
 * desc   : 我的维保工单
 */
public final class MaintenanceWorkOrderActivity extends AppActivity {
    ...
    protected int getLayoutId() {
        return R.layout.maintenance_workorder_activity;
    }
                        ...
                        public void onSucceed(Object result) {
                            if (result != null) {
                                ...
                                if (Util.getJSONType(replaceJson)) {
                                    ...
                                    new SelectDialog.Builder(MaintenanceWorkOrderActivity.this)
                                            .setTitle("选择公司")
                                            .setSingleSelect()
                                            .setList(dataSet)
                                            .setSelect(0)
