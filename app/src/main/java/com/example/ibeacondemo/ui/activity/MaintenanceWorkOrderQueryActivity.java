 ...
 * desc   : 维保工单查询页面
 */
public final class MaintenanceWorkOrderQueryActivity extends AppActivity {

    private TextView tv_title_company_name;
    private TextView mCompanyName, mEquipmentName, mDeviceModel, mMaintenanceNum;
    ...
    protected int getLayoutId() {
        return R.layout.maintenance_workorder_query_activity;
    }
    ...
    protected void initView() {
        ...
        mMaintenanceNum = findViewById(R.id.tv_maintenance_num);
                        ...
                        public void onSucceed(Object result) {
                            if (result != null) {
                                ...
                                if (Util.getJSONType(replaceJson)) {
                                    ...
                                    new SelectDialog.Builder(MaintenanceWorkOrderQueryActivity.this)
                                            .setTitle("选择公司")
                                            .setSingleSelect()
                                            .setList(dataSet)
                                            .setSelect(0)
